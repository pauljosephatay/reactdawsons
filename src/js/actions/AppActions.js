...
export function login(username, password) {
  return dispatch => {
    ...
    bcrypt.hash(password, salt, (err, hash) => {
      ...
      auth.login(username, hash, (success, err, data) => {
 ...
 */
function forwardTo(location, dispatch) {
...
/**
 * Update drive function
 * @param {number} index id of drive
 * @param {string} setting property of drive of update
 * @param {number} value new value of the drive property
 */
export function updateDrive({ index, setting, value }) {
  return { type: UPDATE_DRIVE, index, setting, value };
}

/**
 * Update user drive function
 * @param {number} id of the drive to be active
 */
export function setActiveDrive(id) {
  return { type: SET_ACTIVE_DRIVE, id };
}

export function toggleSeatFunction(id) {
  return { type: TOGGLE_SEAT_FUNCTION, id };
}

export function setUser(user) {
  return { type: SET_ACTIVE_DRIVE, user };
}
